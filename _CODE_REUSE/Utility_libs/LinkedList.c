...
//    LL_LOG_DEBUG("before_index_node: %p", removed_node);
//    LL_LOG_DEBUG("before_index_node.next: %p", removed_node->next_node);
//    LL_LOG_DEBUG("before_index_node.data: %d", removed_node->data);
//    LL_LOG_DEBUG("-------------");
