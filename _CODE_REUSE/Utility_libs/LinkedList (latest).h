...
{
  LinkedList_node_t*        prev_node;        /**< Points to the previous node in the link. */
  LinkedList_node_t*        next_node;        /**< Points to the next node in the link. */
  void*                     data;             /**< The data contained within the node. */
  bool                      node_occupied;    /**< Indicates whether this node is occupied in the buffer. */
};
